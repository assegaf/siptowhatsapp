...
4. no 4. [Filtered call] Dont cut call/force hangup before ended by sip2wa server, if you do this twice, will be rejected call for entire day.
...
1. Sip code 200 , normal answer
2. Sip code 488, for non whatsapp dial result.
3. Sip code 503, filtered / rejected call like in no 4, 5 and 6 filter.
4. Sip code 486 for offline phone (after 15-20s try), or voice call that rejected by whatsapp user (callee).
